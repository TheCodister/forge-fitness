...
const BrandMark = () => (
  <span className="ff-brand-mark" aria-hidden="true">
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        className="ff-bm-glyph"
        d="M 7 7 H 25 V 13 H 13 V 14 H 20 V 18 H 13 V 25 H 7 Z"
      />
      <path
        className="ff-bm-glyph"
        d="M 22.5 20 L 25 22.5 L 22.5 25 L 20 22.5 Z"
      />
    </svg>
  </span>
);
...
export const metadata = {
  ...
  description:
    "Pay-per-token AI coaching. Three tiers, six frontier models. No contracts.",
};
    ...
    <div className="forge-landing">
      ...
      <nav className="ff-nav">
        <div className="ff-container ff-nav-inner">
          ...
          <div className="ff-nav-links">
            ...
            <Link href="/pricing" style={{ color: "var(--ff-accent)" }}>
              Pricing
            </Link>
          ...
          <div className="ff-nav-cta">
            ...
            <Link
              href="/dashboard"
              className="ff-btn ff-btn-primary ff-btn-arrow"
            >
              Start Training
            </Link>
          </div>
      ...
      <section className="ff-section" style={{ paddingBottom: 0 }}>
        <div className="ff-container">
          <div style={{ textAlign: "center", paddingBottom: 80 }}>
            <div className="ff-eyebrow" style={{ marginBottom: 24 }}>
            ...
            >
              Three tiers,
              <br />
              <span style={{ color: "var(--ff-accent)", fontStyle: "italic" }}>
                no contracts.
              </span>
            </h1>
            <p
            ...
            >
              ...
              (input tokens). No peak-hour surge, no annual lock-in. Cancel
              mid-set if you want.
            </p>
          </div>
        </div>
        ...
        <div className="ff-container">
          <div className="ff-pricing">
            ...
            <div className="ff-price">
              ...
              <Link
                href="/dashboard"
                className="ff-btn ff-btn-dark ff-btn-arrow"
              >
                Spin up locally
              </Link>
            </div>
        ...
        <div className="ff-container">
          <div className="ff-section-head">
            <h2>
              All six
              <br />
              <span className="ff-accent-text">trainers.</span>
            </h2>
            <div className="ff-section-meta">
              Every model on staff, their context window, and what they cost per
              million tokens. Mix and match within your tier at no extra charge.
            </div>
          </div>
          ...
          >
            ...
            >
              {["Trainer", "Context", "In / 1M", "Out / 1M", "Tier"].map(
                (h) => (
                  <div
                    key={h}
                    style={{
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  gap: 16,
                  borderBottom:
                    i < 5 ? "1px solid var(--ff-line-soft)" : undefined,
                  alignItems: "center",
                }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <div
                    className={`ff-monogram${t.accent ? " accent" : ""}`}
                    style={{
                      width: 48,
                      height: 48,
                      fontSize: 16,
          ...
          >
            * Self-hosted models require your own infrastructure. Forge provides
            the tooling; compute costs are yours.
          </p>
        </div>
      </section>
        ...
        <div className="ff-container">
          <div className="ff-section-head">
            <h2>
              Common
              <br />
              <span className="ff-accent-text">questions.</span>
            </h2>
          </div>
          <div
            style={{
      ...
      <section className="ff-cta-strip">
        <div className="ff-container ff-cta-inner">
          ...
          <p>
            First 10,000 tokens free. No credit card to sign up. Cancel anytime.
          </p>
          <div
            style={{
              display: "flex",
        ...
        <div className="ff-container">
          <div className="ff-footer-top">
            <div className="ff-footer-brand">
              ...
              <p>
                Personal coaching, hybrid programming, and an AI training
                partner. Built in Brooklyn since 2018.
              </p>
            </div>
            <div className="ff-footer-col">
              ...
              <ul>
                ...
                <li>
                  <Link href="/trainer">AI Coach</Link>
                </li>
              </ul>
            </div>
            <div className="ff-footer-col">
            ...
            <div className="ff-footer-col">
              ...
              <ul>
                <li>
                  <a href="#">hello@forgefit.co</a>
                </li>
                <li>
                  <a href="#">+1 (718) 555-0199</a>
                </li>
                <li>
                  <a href="#">Instagram</a>
                </li>
